...
namespace Pos點餐
{
    ...
    {
        public static void GeneratePanel(List<Item> items)
        {
            ...
            EventHandlers.Notify(result, items.Sum(x => x.sum).ToString());
            
        }

        private static FlowLayoutPanel GeneratePanelHeadUI()
        {
